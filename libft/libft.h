...
int					newline_append(t_line *buffer,
					char **next_line, char **line);
int					conditional_read(int fd,
					t_line *buffer, char **next_line);
int					buffer_append(t_line *buffer,
					char **next_line, char **line);
